...
stringType=Object.prototype.toString.call(value);stringType=stringType.split(" ")[1];return stringType.substring(0,stringType.length-1).toLowerCase();};var createDebugObjectDisplay=function(target){var display=Object.create(null);var proto=Object.getPrototypeOf(target);for(var name in target){if(target.hasOwnProperty(name)){display[name]=target[name];}}
