...
var errorLog=[];var RUNTIME_COUNTER_Testing=0;var checkInProgress=function(){return RUNTIME_COUNTER_Testing>0;};var getType=function(value){var baseTypes="[boolean][number][string][object][function][array][symbol]";var stringType;var base;var baseText="";if(value===undefined||value===null){return"undefined";}
baseText=Object.prototype.toString.call(value);stringType=baseText.split(" ")[1];baseType=baseText.split(" ")[0].substring(1).toLowerCase();stringType=stringType.substring(0,stringType.length-1).toLowerCase();if(baseTypes.indexOf("["+stringType+"]")===-1){return baseType;}
